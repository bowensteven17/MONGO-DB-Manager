      ...
      <div className="flex-1 grid grid-cols-1 xl:grid-cols-2 gap-6 min-h-0">
        ...
        <div className="space-y-4 flex flex-col min-h-0">
          ...
          <div className="flex-1">
            ...
            <div 
              className={`border-2 border-dashed rounded-xl p-6 text-center transition-all duration-200 h-full min-h-[300px] flex flex-col justify-center ${
                isDragOver 
                ...
                <>
                  ...
                  <div className="space-y-4">
                    <input
                      ...
                      id="file-upload-collections"
                      className="hidden"
                    />
                    <label
                      htmlFor="file-upload-collections"
                  ...
                  <div>
                    ...
                    <button
                      onClick={() => {
                        ...
                        setBackupCollections([]);
                        setSelectedCollections(new Set());
                        const fileInput = document.getElementById('file-upload-collections');
                        if (fileInput) fileInput.value = '';
                      }}
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm font-mono"
              />
        ...
        <div className="space-y-4 flex flex-col min-h-0 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-1 min-h-0">
              {availableDatabases.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 h-full overflow-y-auto pr-2">
                  {availableDatabases.map((db) => (
                    <label
                      key={db.name}
                      className={`relative flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all duration-200 h-fit ${
                ...
                <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg h-full flex flex-col justify-center">
